-- located in the Snowflake account: https://app.snowflake.com/europe-west4.gcp/zs02445/wTKMfkY5AAa#query 

-- creation of the database as stated in the challenge 
-- https://docs.snowflake.com/en/user-guide/sample-data-using
CREATE DATABASE nimbus_test;
USE DATABASE nimbus_test;


--creation of the warehouse as stated in the challenge 
-- https://app.snowflake.com/europe-west4.gcp/zs02445/w1boZsqj4lHW/query
...
-- creation of the public data table as stated in the chlalenge
...
-- creation of the email table as stated in the challenge
...
-- https://app.snowflake.com/europe-west4.gcp/zs02445/w4BHsIbgQfw8/query
SELECT email
